...
export class KeynoteApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiKeynoteCreateKeynotePostRaw(requestParameters: ApiKeynoteCreateKeynotePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KeynoteDTOResponseWrapper>> {
    ...
    /**
     */
    async apiKeynoteCreateKeynotePost(requestParameters: ApiKeynoteCreateKeynotePostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KeynoteDTOResponseWrapper> {
    ...
    /**
     */
    async apiKeynoteDeleteKeynoteDeleteRaw(requestParameters: ApiKeynoteDeleteKeynoteDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StringResponseWrapper>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiKeynoteDeleteKeynoteDelete(requestParameters: ApiKeynoteDeleteKeynoteDeleteRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StringResponseWrapper> {
