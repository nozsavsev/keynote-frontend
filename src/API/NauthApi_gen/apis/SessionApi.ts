...
export class SessionApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiSessionGetMyGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SessionDTOListResponseWrapper>> {
    ...
    /**
     */
    async apiSessionRevokeAllMyDeleteRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StringResponseWrapper>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiSessionRevokeCurrentDeleteRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StringResponseWrapper>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiSessionRevokeDeleteRaw(requestParameters: ApiSessionRevokeDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StringResponseWrapper>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiSessionRevokeDelete(requestParameters: ApiSessionRevokeDeleteRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StringResponseWrapper> {
