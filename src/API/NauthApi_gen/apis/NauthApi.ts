...
export class NauthApi extends runtime.BaseAPI {
  ...
  /**
   */
  async apiNauthFetchUsersPostRaw(
    requestParameters: ApiNauthFetchUsersPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async apiNauthGetUserByIdPostRaw(
    requestParameters: ApiNauthGetUserByIdPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async apiNauthGetUserBySessionIdPostRaw(
    requestParameters: ApiNauthGetUserBySessionIdPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FullSessionDTOResponseWrapper>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async apiNauthGetUserBySessionIdPost(
    requestParameters: ApiNauthGetUserBySessionIdPostRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<FullSessionDTOResponseWrapper> {
