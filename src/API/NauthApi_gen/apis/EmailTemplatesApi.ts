...
export class EmailTemplatesApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiEmailTemplatesAllGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmailTemplateDTOListResponseWrapper>> {
    ...
    /**
     */
    async apiEmailTemplatesDeleteRaw(requestParameters: ApiEmailTemplatesDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StringResponseWrapper>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiEmailTemplatesDelete(requestParameters: ApiEmailTemplatesDeleteRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StringResponseWrapper> {
    ...
    /**
     */
    async apiEmailTemplatesIdGetRaw(requestParameters: ApiEmailTemplatesIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmailTemplateDTOResponseWrapper>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling apiEmailTemplatesIdGet().'
            );
        }
    ...
    /**
     */
    async apiEmailTemplatesIdGet(requestParameters: ApiEmailTemplatesIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EmailTemplateDTOResponseWrapper> {
    ...
    /**
     */
    async apiEmailTemplatesPostRaw(requestParameters: ApiEmailTemplatesPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmailTemplateDTOResponseWrapper>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiEmailTemplatesPost(requestParameters: ApiEmailTemplatesPostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EmailTemplateDTOResponseWrapper> {
    ...
    /**
     */
    async apiEmailTemplatesPutRaw(requestParameters: ApiEmailTemplatesPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EmailTemplateDTOResponseWrapper>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiEmailTemplatesPut(requestParameters: ApiEmailTemplatesPutRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EmailTemplateDTOResponseWrapper> {
